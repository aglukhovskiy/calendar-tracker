...
function initializeEventHandlers() {
    ...
    if (addRegularEventBtn) {
        addRegularEventBtn.addEventListener('click', async () => {
            ...
            const selectedDays = Array.from(document.querySelectorAll('#regular-event-weekdays .weekday-btn.selected'))
            ...
            endTimeInput.value = '';
            document.querySelectorAll('#regular-event-weekdays .weekday-btn.selected')
